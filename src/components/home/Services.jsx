    ...
    return (
        <div className="max-w-[1800px] mx-auto font-josefin-sans lg:mt-36">
            ...
            <div data-aos="fade-right">
                <img className="w-[1200px] h-[700px] rounded-3xl border-b-[10px] border-orange-300" src={imagesArray[slideNumber]} alt="" />
            </div>
