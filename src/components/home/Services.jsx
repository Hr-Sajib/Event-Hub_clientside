        ...
        <div className="max-w-[1800px] mx-auto font-josefin-sans lg:mt-36 relative">
            ...
            <div data-aos="fade-left" className="absolute top-[255px] left-10 w-[1100px] ml-[600px] ">
                ...
                >
                    ...
                    <SwiperSlide>
                        <div className="h-[600px] w-[1000px] border-l-[10px] border-t-[5px]  border-[#1d4ed8]  bg-orange-950 rounded-3xl bg-opacity-60 backdrop-blur-sm  ml-12">
                    ...
                    <SwiperSlide>
                        ...
                        <p className="text-white text-2xl p-5">Ensuring a safe and secure environment is crucial for any event. Our security services are designed to give you peace of mind by protecting guests, staff, and property. We collaborate with professional security teams to conduct risk assessments, create customized security plans, and deploy trained personnel on-site. From access control and guest monitoring to emergency response protocols, every aspect of security is managed meticulously. Advanced technology like surveillance cameras and communication systems is integrated to monitor the event in real-time.</p>
                ...
                <div className="flex justify-end mx-10 mt-10 relative bottom-[130px] right-12 z-20">
                    <button className="bg-white rounded-xl text-black font-bold p-3 text-xl hover:bg-gray-200 ">See Our Approach</button>
                </div>
