    ...
    return (
        <div className=" mx-2 font-josefin-sans lg:mt-36 relative">
            ...
            <div data-aos="fade-left" className=" mr-[120px]">
                <p className="text-[5vw]">Our Services</p>
                <p className="text-xl ml-2 mb-10">Transforming visions into unforgettable experiences, we handle every detail—from concept to execution—ensuring your event is flawless and unique.</p>
            </div>
            ...
            {/* text box div  */}
            <div data-aos="fade-left" className="absolute top-[32vh] left-[23vw] w-[72vw]">
