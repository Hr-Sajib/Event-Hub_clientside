...
const OurServices = () => {
    ...
    return (
        <div className="">
            <div className=" mx-2 font-josefin-sans lg:mt-36 relative">

            {/* image div  */}
            <div data-aos="fade-right">
                <img className={`${slideNumber == 0 ? ' border-orange-400' : slideNumber == 1 ? ' border-red-500' : slideNumber == 2 ? ' border-[#fef3c7]':slideNumber == 3 ? ' border-[#84cc16]':slideNumber == 4 ? ' border-[#b91c1c]':slideNumber == 5 ? ' border-[#0ea5e9]':  'border-[#8b5cf6]' } w-[65vw] h-[70vh] object-right object-cover rounded-3xl border-b-[10px]`} src={imagesArray[slideNumber]} alt="" />
            </div>

            {/* text box div  */}
            <div data-aos="fade-left" className="absolute top-[7vh] left-[23vw] w-[72vw]">
                ...
                >
                    <SwiperSlide>
                        <div className="h-[55vh] w-[65vw] border-l-[10px] border-t-[5px]  border-orange-400  bg-orange-950 rounded-3xl bg-opacity-60 backdrop-blur-sm  ml-12">
                            <p className="text-white text-[4vw] ml-3">PLANNING</p>
                            <p className="text-white text-[1.2vw] p-5  h-[22vh] ">Transforming ideas into reality requires meticulous planning. From conceptualizing the event’s flow to managing budgets and schedules, our team crafts a detailed roadmap that aligns with your vision. We coordinate with vendors, create timelines, and anticipate potential challenges to ensure everything unfolds seamlessly. With a keen eye for detail and a proactive approach, we turn complex logistics into smooth operations, letting you focus on enjoying your special occasion.</p>
                    ...
                    <SwiperSlide>
                        <div className="h-[55vh] w-[65vw] border-l-[10px] border-t-[5px]  border-red-600  bg-orange-950 rounded-3xl bg-opacity-60 backdrop-blur-sm  ml-12">
                        <p className="text-white text-[4vw] ml-3">DESIGNING</p>
                        <p className="text-white text-[1.2vw] p-5  h-[22vh] ">Imagine a space that perfectly reflects your style and vision. Our design services turn this vision into an extraordinary experience. By blending creative concepts with practical design, we create stunning layouts, color schemes, and decor elements. Whether you envision an elegant ballroom or a casual outdoor setting, our designs ensure every detail enhances the atmosphere. From lighting to seating arrangements, each element is thoughtfully curated to create a memorable visual impact.</p>
                        <div className="flex justify-end mr-[30px]">
                            <div className="h-[150px] w-[150px] bg-white flex justify-center items-center rounded-full p-">
                    ...
                    <SwiperSlide>
                        <div className="h-[55vh] w-[65vw] border-l-[10px] border-t-[5px]  border-[#0ea5e9]  bg-orange-950 rounded-3xl bg-opacity-60 backdrop-blur-sm  ml-12">
                        <p className="text-white text-[4vw] ml-3">MEDIA</p>
                        <p className="text-white text-[1.2vw] p-5  h-[22vh] ">Make a lasting impression with dynamic media coverage that showcases your event’s highlights. Our media services include professional photography, videography, and live streaming, capturing every memorable moment. We also handle social media and promotional content, amplifying your event’s reach and engagement. By blending creativity with technical expertise, we ensure your event is presented in the best possible light, creating lasting memories and broadening your audience’s impact.</p>
                        <div className="flex justify-end mr-[30px]">
                            <div className="h-[150px] w-[150px] bg-white flex justify-center items-center rounded-full p-">
                    ...
                    <SwiperSlide>
                        <div className="h-[55vh] w-[65vw] border-l-[10px] border-t-[5px]  border-[#8b5cf6]  bg-orange-950 rounded-3xl bg-opacity-60 backdrop-blur-sm  ml-12">
                        <p className="text-white text-[4vw] ml-3">SECURITY</p>
                        <p className="text-white text-[1.2vw] p-5  h-[22vh] ">Ensuring a safe and secure environment is crucial for any event. Our security services are designed to give you peace of mind by protecting guests, staff, and property. We collaborate with professional security teams to conduct risk assessments, create customized security plans, and deploy trained personnel on-site. From access control and guest monitoring to emergency response protocols, every aspect of security is managed meticulously. Advanced technology like surveillance cameras and communication systems is integrated to monitor the event in real-time.</p>
                        <div className="flex justify-end mr-[30px]">
                            <div className="h-[150px] w-[150px] bg-white flex justify-center items-center rounded-full p-">
            ...
            <div className="mx-[5vw] mt-36">
                ...
                {/* designing */}
                <div data-aos="fade-left" className="font-josefin-sans border-l-2 border-t-2 border-red-600 rounded-tl-3xl  p-10">
                ...
                {/* foods */}
                <div data-aos="fade-left" className="font-josefin-sans border-l-2 border-t-2 border-green-600 rounded-tl-3xl p-10">
                ...
                {/* media */}
                <div data-aos="fade-left" className="font-josefin-sans border-l-2 border-t-2 border-purple-600 rounded-tl-3xl p-10">
